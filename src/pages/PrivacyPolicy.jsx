  ...
  <div className="max-w-3xl mx-auto px-4 py-6 sm:py-10">
    ...
    <section className="mb-6">
      ...
      <p className="text-lg text-muted-foreground">
        This Privacy Policy displays how we collect, use and protect your personal information.
      </p>
    </section>
    ...
    <section className="mb-6">
      ...
      <ul className="list-disc list-inside text-muted-foreground mb-2">
        ...
        <li>To advertise our products or services which may be of interest to you</li>
        <li>To use it in our market research</li>
        <li>To protect your and other’s interests</li>
      </ul>
      <p className="text-muted-foreground mb-2">
        We can use these data on the following grounds:
      </p>
      <ul className="list-disc list-inside text-muted-foreground mb-2">
        <li>When a user gives consent</li>
        <li>When it is absolutely necessary to enter into a contract with the user</li>
        <li>To protect the interests of our users</li>
        <li>Where these interests do not infringe on our users’ rights</li>
      </ul>
      <p className="text-muted-foreground">
        We may send promotional emails about new products and special offers as per your interest. From time to time, we may also use your information to contact you for market research purposes through email or phone.
      </p>
    </section>
    ...
    <section className="mb-6">
      ...
      <ul className="list-disc list-inside text-muted-foreground mb-2">
        <li><span className="font-semibold">Session Management</span> – Cookies let websites recognize users and recall their individual login information and preferences such as sports news versus politics.</li>
        <li><span className="font-semibold">Personalization</span> – Customized advertising is the main way cookies are used to personalize your sessions. You may view certain items or parts of a site and cookies use this data to help build targeted ads that you might enjoy.</li>
        <li><span className="font-semibold">Tracking</span> – Shopping sites use cookies to track items users previously viewed, allowing the sites to suggest other goods they might like and keep items in shopping carts while they continue shopping.</li>
      </ul>
      <p className="text-muted-foreground mb-2">
        We use cookies to identify which pages are being used extensively. This helps us keep track of the web page’s visibility and traffic. It helps to understand the customer’s choice of trends. It helps us to monitor which pages you find useful and which you do not. You can choose to accept or decline cookies. Most web browsers automatically accept cookies but you can usually modify your browser setting to decline cookies if you prefer. This may prevent you from taking full usage of the website.
      </p>
      <p className="text-muted-foreground">
        For more information, consult with our expert. You can reach them by email at <a href="mailto:info@slotpilot.in" className="text-primary underline">info@slotpilot.in</a> and they’ll assist you as soon as possible.
      </p>
    </section>
  </div>
);
